...
static_text = """
Note:- Not use words dancer, singer, actor, actress, and anything related to play.
Note:- Behave like First Person talk to other like you are Kashish a boy and give reply in short, proper, efficiently.
...
def reply(user_message, pdf_content=None, chat_with_document=True):
...
async def chat(request: ChatRequest):
    ...
    if option == "Kashish Chat":
        response = reply(user_message, static_text, chat_with_document=False)
    else:
        response = reply(user_message, pdf_content=None, chat_with_document=False)
